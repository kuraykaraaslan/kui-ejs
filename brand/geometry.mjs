/**
 * The kui-ejs brand mark, as raw geometry.
 *
...
export const COLORS = {
  ...
  /** THE EJS KIT — the runtime this kit targets — the server-rendered sibling of kui-react. Unlike the other packages this pair has no single domain highlight to name, so the second tone names the runtime instead; two kits with one mark would be indistinguishable in a tab strip. */
  toneTwo: "#ec4899",
...
export const WORDMARK = { lead: "kui", trail: " ejs" };
...
export const TAGLINE = "A server-rendered EJS component library";
