...
export function buildScrollAreaData(): ShowcaseItem[] {
  ...
  <div tabindex="0" role="region" aria-label="Scrollable content" class="h-40 w-64 rounded-md border border-border p-3 overflow-y-auto overflow-x-hidden [scrollbar-width:thin] [scrollbar-color:var(--border-strong)_transparent] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:bg-border-strong [&::-webkit-scrollbar-thumb]:rounded-full">
  ...
  children: itemListHtml
        ...
        },
        {
          ...
          layout: 'stack' as const,
          previewHtml: `<div class="p-4">
  <div tabindex="0" role="region" aria-label="Scrollable content" class="w-full rounded-md border border-border p-3 overflow-x-auto overflow-y-hidden [scrollbar-width:thin] [scrollbar-color:var(--border-strong)_transparent] [&::-webkit-scrollbar]:h-2 [&::-webkit-scrollbar-thumb]:bg-border-strong [&::-webkit-scrollbar-thumb]:rounded-full">
