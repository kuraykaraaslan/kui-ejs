...
function searchBar(extra = '') {
  ...
  <input type="search" role="searchbox" aria-label="Search" placeholder="Search…" autocomplete="off" ${extra}
...
function searchBarWithValue(value: string) {
  ...
  <input type="search" role="searchbox" aria-label="Search" value="${value}" autocomplete="off"
...
export function buildMoleculeTextData(): ShowcaseItem[] {
  ...
  <input type="search" role="searchbox" aria-label="Search" placeholder="Search…" autocomplete="off"
