          ...
          <div class="flex items-start gap-1.5">
            ...
            <% if (schema.example !== undefined) { %>
              <%- include('../../ui/Tooltip', {
                ...
                placement: 'top',
                children: '<span class="w-3 h-3 inline-flex items-center justify-center text-text-disabled shrink-0 mt-0.5 cursor-help"><i class="fa-solid fa-circle-info" role="img" aria-label="Example value"></i></span>'
              }) %>
            <% } %>
          </div>
