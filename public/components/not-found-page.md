...
<div class="min-h-screen flex flex-col items-center justify-center px-4 bg-surface-base">
  ...
  >
    <i class="fa-solid fa-magnifying-glass text-primary-fg text-2xl" aria-hidden="true"></i>
  </div>
  ...
  <div class="mt-8 flex flex-wrap items-center justify-center gap-3">
    <a
      href="<%= _homeHref %>"
      class="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-semibold text-primary-fg transition-transform hover:scale-[1.02] active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-border-focus"
