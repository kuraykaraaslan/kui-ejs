...
>
  ...
  <div
    id="<%= _id %>-panel"
    tabindex="-1"
    class="relative z-10 w-full border border-border bg-surface-raised shadow-xl flex flex-col focus-visible:outline-none<%= _fullscreen ? ' rounded-none max-w-none h-full' : ' rounded-xl ' + sizeClass %>"
  >
